  ...
  return (
    <section className="mx-auto max-w-4xl px-5 py-24 sm:py-32">
      ...
      <p className="mt-10 max-w-2xl border-l-2 border-transparent pl-8 text-[17px] leading-relaxed text-muted sm:pl-12">
        Everything here was built for Damon’s own eight-office firm first, then refined, tested
        and used every day. AI is the foundation. Beyond it, the {`Firm of the Future`} system
        covers strategy, pricing, positioning, marketing, sales, advisory services, teams and
        growth. One system. One goal: build a better firm and live a better life.
      </p>
    </section>
  );
}
